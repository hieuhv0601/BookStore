		...
		<main class="main-content  mt-0">
			<section>
                ...
                <div class="col-3 me-auto px-1">
                  <a class="btn btn-outline-light w-100" href="https://accounts.google.com/o/oauth2/auth?scope=profile email&redirect_uri=http://localhost:8681/BookStore/login-google&response_type=code&client_id=816860003507-6r7mp8dduvmeho2umae7uef2qq98ienk.apps.googleusercontent.com&approval_prompt=force">
                    <svg
                      width="24px"
                      height="32px"
                      viewBox="0 0 64 64"
