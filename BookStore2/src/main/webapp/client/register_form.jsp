...
<jsp:directive.include file="header.jsp" />
    ...
    <section class="min-vh-100 mb-8">
      <div
        ...
        style="
          background-image: url('${pageContext.request.contextPath}/assets/img/curved-images/curved14.jpg');
        "
      >
            ...
            <div class="card z-index-0">
              ...
              <div class="row px-xl-5 px-sm-4 px-3">
                ...
                <div class="col-3 me-auto px-1">
                  <a class="btn btn-outline-light w-100" href="https://accounts.google.com/o/oauth2/auth?scope=profile email&redirect_uri=http://localhost:8681/BookStore/register-google&response_type=code&client_id=816860003507-6r7mp8dduvmeho2umae7uef2qq98ienk.apps.googleusercontent.com&approval_prompt=force">
                    <svg
                      width="24px"
                      height="32px"
                      viewBox="0 0 64 64"
              ...
              <div class="card-body">
                <form role="form text-left"  action="register_customer" method="post" id="customerForm">
                  <div class="mb-3">
                    <input
                      type="text"
                      class="form-control"
                  ...
                  <div class="mb-3">
                    ...
                    <input
                      ...
                      aria-describedby="telephone-addon"
                    />
                  </div>
                  <div class="mb-3">
                    <input
    ...
    <script src="${pageContext.request.contextPath}/assets/js/authenJs/soft-ui-dashboard.min.js?v=1.0.3"></script>
    <script src="${pageContext.request.contextPath}/assets/js/authenJs/core/popper.min.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/authenJs/core/bootstrap.min.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/authenJs/plugins/perfect-scrollbar.min.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/authenJs/plugins/smooth-scrollbar.min.js"></script>
    
    <script type="text/javascript">
  $(document).ready(function () {
    // Initialize the jQuery Validate plugin for the customerForm.
    $("#customerForm").validate({
      ...
      rules: {
        ...
        confirmpassword: {
          required: true,
          equalTo: "#password", // Make sure it matches the password field.
        },
        telephone: "required",
      },
