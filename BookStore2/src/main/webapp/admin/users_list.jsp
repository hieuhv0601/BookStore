											...
											<tbody>
												<tr>
													...
													<td>
														<div class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input"
																...
																class="custom-control-label" for="${user.userId}"></label>
														</div>
													</td>
													...
													<td>
														...
														</p> <small class="mb-0 text-muted">${user.lastName}
															${user.firstName}</small> <p><small class="mb-0 text-muted">Id: ${user.userId}</small></p> 
													</td>
													<td>
														<p class="mb-0 text-muted">${user.email}</p> <small
														class="mb-0 text-muted">${user.telephone}</small>
													</td>
													...
													<td><button
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a class="dropdown-item" href="edit_user?id=${user.userId}">Edit</a> <a
																class="dropdown-item" href="#" onclick="confirmDelete(${user.userId}); return false;">Remove</a> <a
