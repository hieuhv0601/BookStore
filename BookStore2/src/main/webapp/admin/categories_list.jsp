											...
											<tbody>
												<tr>
													...
													<td>
														<div class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input"
																id="${category.categoryId}"> <label
																class="custom-control-label" for="${category.categoryId}"></label>
														</div>
													</td>
													...
													<td>
														<p class="mb-0 text-muted">${category.categorySlug}</p>
													</td>
													...
													<td><button
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a class="dropdown-item" href="edit_category?id=${category.categoryId}">Edit</a> <a
																class="dropdown-item" href="#" onclick="confirmDelete(${category.categoryId}); return false;">Remove</a> <a
